...
export const zfcAxiomRegistry: Record<ZfcAxiomId, ZfcAxiomDefinition> = {
  ...
  AXIOM_REGULARITY: {
    id: 'AXIOM_REGULARITY',
    nameZh: '正则公理/基础公理 (Regularity / Foundation)',
  ...
  AXIOM_CHOICE: {
    id: 'AXIOM_CHOICE',
    nameZh: '选择公理 (Axiom of Choice - AC)',
